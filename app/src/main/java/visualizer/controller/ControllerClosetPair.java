...
public class ControllerClosetPair implements Initializable{ {
    public ControllerClosetPair () {}
    ...
    public void initialize(URL location, ResourceBundle resources) {
                ...
                // add figure
                Chart.getData().add(linear_searchSeries);
                Chart.getData().add(binary_searchSeries);
    }
}
